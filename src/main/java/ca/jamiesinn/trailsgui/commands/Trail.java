    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
    {
        if (cmd.getName().equalsIgnoreCase("Trail"))
        {
            ...
            for (String string : this.main.getConfig().getStringList("disabledWorlds"))
            {
                ...
                {
                    if (!player.hasPermission("trailgui.commands.angryvillager"))
                    {
                    ...
                    if (!player.hasPermission("trailgui.commands.other.angryvillager"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.cloud"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.cloud"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.criticals"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.criticals"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.dripwater"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.driplava"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                if (args[0].equalsIgnoreCase("DripWater"))
                {
                    ...
                    if (!player.hasPermission("trailgui.commands.other.dripwater"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.enchantment"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.enchantment"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.spark"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.spark"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.flame"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.flame"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.happyvillager"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.happyvillager"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.instantspell"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.instantspell"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.largesmoke"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.largesmoke"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.lava"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.lava"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.magiccrit"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.magiccrit"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.mobspell"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.mobspell"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.mobspellambient"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.mobspellambient"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.note"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.note"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.portal"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.portal"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.reddust"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.reddust"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.coloredreddust"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.coloredreddust"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.slime"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.slime"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.snowshovel"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.snowshovel"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.snowballpoof"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.snowballpoof"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.spell"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.spell"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.splash"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.splash"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.townaura"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.townaura"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.wake"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.wake"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.witchmagic"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.witchmagic"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.hearts"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.hearts"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                {
                    if (!player.hasPermission("trailgui.commands.endersignal"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                    ...
                    if (!player.hasPermission("trailgui.commands.other.endersignal"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
                ...
                if (args[0].equalsIgnoreCase("ClearAll"))
                {
                    ...
                    if (!player.hasPermission("trailgui.commands.other.clearall"))
                    {
                        player.sendMessage(Main.getPlugin().getConfig().getString("Commands-denyPermissionMessage").replaceAll("&", "§"));
                        return false;
                    }
